    ...
    Signal::derive(move || {
        ...
        let phase_0 = phase(
            ...
            vec![
                (
                    TimeStep::mm_ss(0, 3),
                    AttackUuid::new("48788568-2cf6-42fd-a0a6-65bcbedc8db1"),
                ),
                (
                    TimeStep::mm_ss(0, 14),
                    AttackUuid::new("b34ecb1d-3d12-41c4-8c96-32dfd276d37d"),
                ),
                (
                    TimeStep::mm_ss(0, 23),
                    AttackUuid::new("05d153ac-0f5a-4e9c-8b73-0df0c0e5430d"),
                ),
                (
                    TimeStep::mm_ss(0, 26),
                    AttackUuid::new("6064b938-0437-4ffb-9eff-0071ca505851"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("5ad36fb9-6f02-46ee-ba5c-e015be5fa61d"),
                ),
                (
                    TimeStep::mm_ss(0, 41),
                    AttackUuid::new("fd6da248-3c13-4d08-b846-b7a85dd15740"),
                ),
                (
                    TimeStep::mm_ss(0, 49),
                    AttackUuid::new("c2f3209a-5a6c-4d97-a8c7-5a2a89e02cd6"),
                ),
                (
                    TimeStep::mm_ss(0, 57),
                    AttackUuid::new("b6f020c8-9801-4e19-9e57-844105da8dda"),
                ),
                (
                    TimeStep::mm_ss(1, 8),
                    AttackUuid::new("4f7dd959-d6c9-49ee-9561-2fcfda627bff"),
                ),
                (
                    TimeStep::mm_ss(1, 9),
                    AttackUuid::new("b0e4377b-2106-454e-ac31-fde248f781bf"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("1daa358c-47a8-4b7c-be8f-dacc5ee8edb3"),
                ),
                (
                    TimeStep::mm_ss(1, 30),
                    AttackUuid::new("b27695df-ed78-4c3b-95b1-4091d9dfef25"),
                ),
                (
                    TimeStep::mm_ss(1, 38),
                    AttackUuid::new("7afb05c4-705a-4c81-9d8c-bb894b1667e3"),
                ),
                (
                    TimeStep::mm_ss(1, 42),
                    AttackUuid::new("f83fecbf-3e7f-4e6a-b989-953e62488756"),
                ),
                (
                    TimeStep::mm_ss(1, 52),
                    AttackUuid::new("69476c1b-3b06-446f-8ed5-c99583bc82d2"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("616252a3-c3e1-43d7-b843-aa36569cff2e"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("4bfa08af-4485-4a6d-88d3-d423b797ff97"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("883eb85c-8df1-4b72-9d36-5bae687d6da1"),
                ),
            ],
        );
        let phase_1 = phase(
            ...
            vec![
                (
                    TimeStep::mm_ss(0, 20),
                    AttackUuid::new("68593620-2782-47d5-bbd8-528a3db58e9e"),
                ),
                (
                    TimeStep::mm_ss(0, 36),
                    AttackUuid::new("fbb46d7d-a4a2-45a1-84c1-0c3e4f18fa33"),
                ),
                (
                    TimeStep::mm_ss(0, 44),
                    AttackUuid::new("8aea5614-a47b-4ab6-b8d4-c4c18838e627"),
                ),
                (
                    TimeStep::mm_ss(0, 48),
                    AttackUuid::new("ba1cb4de-5216-4ebb-9148-8d62a5bfdb7e"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("94422db5-0f96-4852-866d-a3e9578028c6"),
                ),
                (
                    TimeStep::mm_ss(1, 4),
                    AttackUuid::new("43746917-ee1e-498e-aeb8-97fa9246a5b0"),
                ),
                (
                    TimeStep::mm_ss(1, 12),
                    AttackUuid::new("e7d4522d-e067-4fa1-9e4a-e2c19edd9be1"),
                ),
                (
                    TimeStep::mm_ss(1, 19),
                    AttackUuid::new("1465b10b-5f8a-49d9-9a8b-d4ccbe14e90a"),
                ),
                (
                    TimeStep::mm_ss(1, 30),
                    AttackUuid::new("b793a531-db29-4bcd-a6c7-fe343961ae35"),
                ),
                (
                    TimeStep::mm_ss(1, 35),
                    AttackUuid::new("2023c45a-9748-4ed3-a49c-74feedf92062"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("ef75e175-0df4-46b4-9f65-9dc8226f4e52"),
                ),
                (
                    TimeStep::mm_ss(1, 52),
                    AttackUuid::new("eb4abfed-0099-4da2-a33f-5a9e2e1befa1"),
                ),
                (
                    TimeStep::mm_ss(2, 2),
                    AttackUuid::new("142c372f-c7f6-4b69-a09e-c42be314911a"),
                ),
                (
                    TimeStep::mm_ss(2, 3),
                    AttackUuid::new("3e358a6f-40f0-4be5-a36b-d11a18acb246"),
                ),
                (
                    TimeStep::mm_ss(2, 15),
                    AttackUuid::new("c0a2f8a0-c3cb-48b4-8203-8fb24a61a846"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("017bc8cd-a93f-4a2b-b3f1-d5c6372159e2"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("8e1a5688-f95e-438d-b3bb-8ad1543828e1"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("bb89e2bd-69bb-4e7a-8900-f05bdf239c9a"),
                ),
            ],
        );
        let phase_2 = phase(
            ...
            vec![
                (
                    TimeStep::mm_ss(0, 20),
                    AttackUuid::new("1aea2cab-ef04-49a4-9ad1-8ca3574ca1cb"),
                ),
                (
                    TimeStep::mm_ss(0, 36),
                    AttackUuid::new("52851734-f062-4ec9-9b81-9b78358573a8"),
                ),
                (
                    TimeStep::mm_ss(0, 44),
                    AttackUuid::new("9442de54-ecb6-43dc-89eb-296630548237"),
                ),
                (
                    TimeStep::mm_ss(0, 48),
                    AttackUuid::new("29eda0ee-d9d4-4b85-9603-3d1832d6e9da"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("9f7d42cf-278f-48cc-824d-b2fc259a502d"),
                ),
                (
                    TimeStep::mm_ss(1, 4),
                    AttackUuid::new("6fb0eaeb-8339-4a10-9740-af219e773a12"),
                ),
                (
                    TimeStep::mm_ss(1, 12),
                    AttackUuid::new("bfcba1ec-d708-4f3d-8352-c969ab722f09"),
                ),
                (
                    TimeStep::mm_ss(1, 19),
                    AttackUuid::new("709dd4ed-9b52-4f3d-907d-57ddf63b3dc4"),
                ),
                (
                    TimeStep::mm_ss(1, 30),
                    AttackUuid::new("5d5dc083-2888-40af-90ae-7b5c0748b5fa"),
                ),
                (
                    TimeStep::mm_ss(1, 35),
                    AttackUuid::new("186d07fc-07ed-49d6-8c3c-d27822032b7b"),
                ),
                (
                    TimeStep::zero(),
                    AttackUuid::new("6349fcea-3143-4bd3-8228-f6a00c461684"),
                ),
                (
                    TimeStep::mm_ss(1, 52),
                    AttackUuid::new("55cf5ae2-1451-4d16-b817-277fa3d9a554"),
                ),
                (
                    TimeStep::mm_ss(2, 2),
                    AttackUuid::new("01cd7b80-5187-4712-a1ad-c8a5d1bf92fe"),
                ),
                (
                    TimeStep::mm_ss(2, 3),
                    AttackUuid::new("f73446ae-2469-4b2f-a2ab-9568ae761781"),
                ),
                (
                    TimeStep::mm_ss(2, 15),
                    AttackUuid::new("c0a2f8a0-c3cb-48b4-8203-8fb24a61a846"),
        ...
        let enrage = [Attack {
            uuid: AttackUuid::new("82b56325-f7e5-4305-96d2-af0750f14515"),
