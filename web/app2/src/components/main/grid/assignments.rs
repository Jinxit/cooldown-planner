...
use fight_domain::{AttackUuid, Spell};
...
fn AssignmentIcon(
    ...
    #[prop(into)] spell: Spell,
    #[prop(into)] assignment: Assignment,
    ...
    let is_not_forced = move || assignment.state != AssignmentState::Locked;
    let is_forced = move || assignment.state == AssignmentState::Locked;
