...
type ClassSignalMap = HashMap<(String, String), Memo<PlayerClass>>;
...
impl ClassCache {
    ...
    pub fn get(&self, character_name: &str, realm_name: &LocalizedString) -> Memo<PlayerClass> {
            ...
            .or_insert_with(move || {
                ...
                Effect::new(move |_| {
                    ...
                    spawn_local({
                        ...
                        async move {
                            let summary =
                                character_summary(character_name, realm_slug, region.get()).await;
